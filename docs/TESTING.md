...
- [ ] The whole bar is opaque and the page ends above it: scroll to the foot of a long page -- a site footer, a cookie banner -- and every control there can be tapped without the bar in the way. Slim, the bar is transparent and the page runs behind it: a control under the slim bar, beside its handle, still takes the tap.
